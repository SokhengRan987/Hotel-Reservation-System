...
<div style="max-width:800px; margin:0 auto;">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:28px;">
        <div>
            <h1 style="font-size:1.8rem; font-weight:800; color:#1e3a8a; margin:0;">Add New Room</h1>
            <p style="color:#6b7280; margin:4px 0 0;">Fill in the details to add a new room</p>
        </div>
        ...
        @csrf
                ...
                <div style="background:#fffaf8; border-radius:14px; padding:28px; box-shadow:0 2px 8px rgba(0,0,0,0.07); margin-bottom:20px; border:1px solid #eae6f6;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                        <div>
                            <label style="font-weight:600; color:#374151; font-size:0.9rem; display:block; margin-bottom:6px;">
                        ...
                        <div>
                            ...
                            <select name="type" required
                                    style="width:100%; padding:10px 14px; border:1px solid #d1d5db; border-radius:8px; font-size:0.95rem; outline:none; background:white;">
                                ...
                                <option value="Presidential" @selected(old('type') === 'Presidential')>Presidential</option>
                            </select>
                        </div>
                        <div>
                            <label style="font-weight:600; color:#374151; font-size:0.9rem; display:block; margin-bottom:6px;">
                                Price per Night (USD) <span style="color:red;">*</span>
                            </label>
                    ...
                    <div style="margin-top:16px;">
                        <label style="font-weight:600; color:#374151; font-size:0.9rem; display:block; margin-bottom:6px;">
                            Features
                            <span style="color:#6b7280; font-weight:400;">(comma-separated)</span>
                        </label>
                        <input type="text" name="features" value="{{ old('features') }}"
                            placeholder="e.g. WiFi, Air Conditioning, King Bed, Mini Bar"
                            style="width:100%; padding:10px 14px; border:1px solid #d1d5db; border-radius:8px; font-size:0.95rem; outline:none;">
                    </div>
                    ...
                    <div style="margin-top:16px;">
                        ...
                        <textarea name="description" rows="3"
                                ...
                                style="width:100%; padding:10px 14px; border:1px solid #d1d5db; border-radius:8px; font-size:0.95rem; outline:none; resize:vertical;">{{ old('description') }}</textarea>
                    </div>
                </div>
